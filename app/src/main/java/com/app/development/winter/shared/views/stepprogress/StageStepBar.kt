package com.app.development.winter.shared.views.stepprogress
...
import com.app.development.winter.shared.views.stepprogress.util.ConfigBuilder
import com.app.development.winter.shared.views.stepprogress.util.StageStepBarLifecycleObserver
...
class StageStepBar @JvmOverloads constructor(
    ...
    private fun drawThumbs(canvas: Canvas, progressBarEnd: Int, drawReverse: Boolean) {
        repeat(numOfStages-1) { stage ->
            if (stage == 0) return@repeat
